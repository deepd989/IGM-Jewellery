          ...
          <View style={styles.bookingBox}>
             ...
             <View style={styles.row}>
                <View style={styles.infoBadge}>
                  ...
                  <Text style={styles.infoText}>{params.date || 'Sun, 30 Nov'}</Text>
                </View>
                <View style={styles.infoBadge}>
                  <Ionicons name="time-outline" size={16} color="#333" />
                  <Text style={styles.infoText}>{params.timeSlot || '12:00 PM'}</Text>
                </View>
             </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  bookingBox: { padding: 16, borderBottomWidth: 8, borderBottomColor: '#F9F9F9' },
  boxTitle: { fontSize: 15, fontWeight: '700', marginBottom: 12 },
  row: { flexDirection: 'row', gap: 8 },
  infoBadge: { flex: 1, height: 50, backgroundColor: '#F5F5F5', borderRadius: 8, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12 },
  infoText: { marginLeft: 8, fontWeight: '600', fontSize: 13 },
  formContainer: { padding: 16 },
  sectionTitle: { fontSize: 15, fontWeight: '700', marginBottom: 16 },
  footerBtn: { backgroundColor: '#000', height: 60, justifyContent: 'center', alignItems: 'center' },
