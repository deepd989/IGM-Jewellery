    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.statusHeader}>
        <Text style={styles.requestId}>
          Request ID{" "}
          <Text style={{ fontWeight: "800" }}>{trial.displayId}</Text>
        </Text>
        <View style={styles.statusBadge}>
          ...
          <Text style={styles.statusBadgeText}>
            {id === "tr_delivered" ? "Delivered" : "In Transit"}
          </Text>
        </View>
      </View>
      ...
      >
        ...
        {trial.items.map((item, idx) => (
          <View key={idx} style={styles.productCard}>
            ...
            {isDelivered && (
              <HapticButton style={styles.addBagBtn}>
          ...
          <View style={styles.timelineDates}>
            ...
            <View style={{ alignItems: "flex-end" }}>
              <Text style={styles.dateLabel}>
                {isDelivered ? "Delivery Date" : "Appointment Date"}
              </Text>
        ...
        {isDelivered ? (
          <View style={styles.deliveredMsgBox}>
            <Text style={styles.msgText}>
              Your return is automatically scheduled for{" "}
              <Text style={{ fontWeight: "700" }}>Fri, 23 April, 2025</Text>
            </Text>
          </View>
        ) : (
          <View style={styles.noticeBox}>
            <Text style={styles.noticeText}>
              Please note: A replica of the original product will be sent to
              you. The return of the products will be automatically scheduled
              for 2 days after the delivery date
            </Text>
          </View>
        )}
        ...
        {isDelivered && (
          <Text style={styles.deliveredSubMsg}>
            Please ensure all items are neatly packed and handed over to pur
            delivery partner
          </Text>
        )}
