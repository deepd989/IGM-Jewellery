      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
         ...
         <View style={styles.section}>
            ...
            <View style={styles.addressCard}>
               <Ionicons name="person-outline" size={20} color="#000" style={styles.addrIcon} />
               <View style={styles.addrContent}>
                  <Text style={styles.addrName}>{order.deliveryAddress?.name}</Text>
                  <Text style={styles.addrText}>{order.deliveryAddress?.line1}</Text>
                  <Text style={styles.addrText}>{order.deliveryAddress?.line2}</Text>
         ...
         <View style={styles.section}>
            <TouchableOpacity style={styles.payHeader} onPress={() => setPayExpanded(!payExpanded)}>
               ...
               <View style={styles.payHeaderRight}>
                  ...
                  <Text style={styles.totalPaid}>₹{order.totalAmount.toLocaleString()}</Text>
                  <Ionicons name={payExpanded ? "chevron-up" : "chevron-down"} size={20} />
               </View>
            </TouchableOpacity>
         ...
         <TouchableOpacity style={styles.bottomHelp}>
...
const styles = StyleSheet.create({
  ...
  productSection: { padding: 16, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  productThumbBox: { height: 200, backgroundColor: '#F9F9F9', borderRadius: 8, justifyContent: 'center', alignItems: 'center', position: 'relative', marginBottom: 16 },
  brandLogo: { position: 'absolute', top: 12, left: 12, width: 40, height: 40, backgroundColor: '#F0F0F0' },
  mainThumb: { width: 140, height: 140, backgroundColor: '#EBEBEB', borderRadius: 70 },
  productInfo: {},
  ...
  trackLink: { fontSize: 13, fontWeight: '700', textDecorationLine: 'underline' },
  policyBox: { padding: 20, alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  policyText: { fontSize: 13, color: '#333' },
  policyLink: { fontSize: 13, fontWeight: '700', textDecorationLine: 'underline', marginTop: 4 },
  cancelBox: { flexDirection: 'row', padding: 16, backgroundColor: '#F9F9F9', alignItems: 'center', gap: 12 },
  ...
  invoiceBtn: { flexDirection: 'row', justifyContent: 'space-between', margin: 16, padding: 16, backgroundColor: '#F5F5F5', borderRadius: 4 },
  invoiceText: { fontSize: 13, color: '#333' },
  downloadText: { fontSize: 13, fontWeight: '700' },
  bottomHelp: { flexDirection: 'row', alignSelf: 'flex-start', alignItems: 'center', padding: 16, gap: 8 },
