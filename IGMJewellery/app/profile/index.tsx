...
const PROFILE_STATS = [
  { id: 'orders', title: 'Orders', desc: 'Your previous orders', icon: 'cart-outline', path: '/orders' },
  { id: 'trial', title: 'Try at Home', desc: 'Your previous orders', icon: 'home-outline', path: '/trial-orders' },
  { id: 'custom', title: 'Customization', desc: 'Your previous orders', icon: 'diamond-outline' },
  { id: 'vault', title: 'GBST Vault', desc: 'Your previous orders', icon: 'shield-checkmark-outline' },
];
...
const MENU_ITEMS = [
  ...
  { id: 'faqs', title: 'FAQs', desc: 'Frequently Asked Questions', path: '/profile/faqs' },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.pointsBadge} onPress={() => router.push('/profile/loyalty')}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.userSection}>
          ...
          <TouchableOpacity style={styles.langSelector} onPress={() => router.push('/profile/language-currency')}>
            <Image source={{ uri: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/255px-Flag_of_India.svg.png' }} style={styles.flag} />
        ...
        <View style={styles.orderCard}>
           ...
           {[1, 2, 3].map((_, i) => (
             <TouchableOpacity key={i} style={styles.subOrderItem} onPress={() => router.push('/orders/ord1')}>
                <View style={styles.subOrderThumb} />
                <View style={styles.subOrderInfo}>
                   <Text style={styles.subOrderStatus}>{i === 2 ? 'Delivered' : 'Dispatched'} on Mon, 2 Nov</Text>
                   <Text style={styles.subOrderTitle}>Diamond Ring 24K, Kal...</Text>
...
const styles = StyleSheet.create({
  ...
  statCard: { width: '46%', backgroundColor: '#FFF', margin: '2%', padding: 16, borderRadius: 8 },
  ...
  menuItem: { flexDirection: 'row', padding: 16, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
  menuIconPlaceholder: { width: 36, height: 36, backgroundColor: '#F0F0F0', borderRadius: 4 },
  ...
  orderCard: { backgroundColor: '#FFF', margin: 16, borderRadius: 12, padding: 16 },
  orderTop: { flexDirection: 'row', alignItems: 'center' },
  orderThumb: { width: 40, height: 40, backgroundColor: '#F0F0F0', borderRadius: 4 },
  ...
  orderStatusRow: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#F5F5F5', padding: 8, borderRadius: 4, marginVertical: 12 },
  statusText: { fontSize: 11, fontWeight: '600' },
  subOrderItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderTopWidth: 1, borderTopColor: '#F0F0F0' },
  subOrderThumb: { width: 50, height: 50, backgroundColor: '#F9F9F9', borderRadius: 4 },
  ...
  footerLinkItem: { padding: 16, borderBottomWidth: 1, borderBottomColor: '#F5F5F5' },
  footerLinkText: { fontSize: 14, fontWeight: '500' },
  logoutBtn: { margin: 24, padding: 16, borderRadius: 8, borderWidth: 1, borderColor: '#DDD', alignItems: 'center' },
  logoutText: { fontSize: 14, fontWeight: '600' },
  version: { textAlign: 'center', color: '#999', fontSize: 10, marginBottom: 40 },
});
