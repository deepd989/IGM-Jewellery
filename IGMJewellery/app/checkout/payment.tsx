...
const PAYMENT_OPTIONS = [
  { id: 'google_pay', title: 'Google Pay', subtitle: 'Enter UPI ID', icon: 'logo-google' },
  { id: 'credit_card', title: 'Credit Card', subtitle: 'Save and Pay via credit cards', icon: 'card-outline' },
  { id: 'debit_card', title: 'Debit Card', subtitle: 'Save and Pay via credit cards', icon: 'card-outline' },
  { id: 'net_banking', title: 'Net Banking', subtitle: 'Save and Pay via credit cards', icon: 'globe-outline' },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.payOnlinePrimary}>
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodSubtitle}>Credit, Debit, Net Banking, UPI & More</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.giftCardBox}>
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodSubtitle}>Avail Additional discounts with gift cards</Text>
            </View>
            <View style={styles.checkboxOutline} />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.payBtn} onPress={handlePaymentNavigation}>
          <Text style={styles.payBtnText}>Proceed to Pay ₹{orderDetails.total.toLocaleString()}</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
