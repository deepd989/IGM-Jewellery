...
const MOCK_REVIEWS = [
  {
    ...
    rating: 4,
    date: '21 Jan, 2025',
    comment: 'Beautiful Product. Delivery was seamless. I will recommend it to my friends. Pick Up attempt failed. Set up a new request',
  },
  {
    id: '2',
    name: 'Anjali Gupta',
  ...
  <View style={styles.reviewItem}>
    ...
    <View style={styles.reviewFooter}>
      ...
      <View style={styles.starsRow}>
        {[1,2,3,4,5].map(i => (
          <Ionicons key={i} name={i <= item.rating ? "star" : "star-outline"} size={14} color={i <= item.rating ? COLORS.textSecondary : '#E0E0E0'} />
        ))}
      </View>
    </View>
...
export const ReviewSection: React.FC<ReviewSectionProps> = ({ product }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.sectionHeader, { marginBottom: SPACING.s }]}>CUSTOMER REVIEWS</Text>
      ...
      <View style={styles.summaryBanner}>
        ...
        <View style={styles.starRowBig}>
             {[1,2,3,4,5].map(i => (
                <Ionicons key={i} name={i <= Math.round(product.rating) ? "star" : "star-outline"} size={20} color="#FFF" />
             ))}
        </View>
