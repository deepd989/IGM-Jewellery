...
const MOCK_BRANDS: Brand[] = [
  {
    profileImageUri:
      "https://drive.google.com/uc?export=download&id=113Cwm5g8GE6YO3rLKFAx_92uRd8uWc7C",
    ...
    collections: [
      {
        ...
        description:
          "Thoughtful jewellery pieces perfect for meaningful gifts.",
  ...
  {
    profileImageUri:
      "https://drive.google.com/uc?export=download&id=1BndyDIunNUIrWRbsrm1Sp-83t5o2jd_n",
    ...
    collections: [
      ...
      },
      {
        ...
        description:
          "Grand designs crafted for your once-in-a-lifetime moments.",
  ...
  {
    profileImageUri:
      "https://drive.google.com/uc?export=download&id=1uyqHO1IyKNvBMI2wNDLrCdOfB8uPKGap",
    businessNameKey: "pcj",
  ...
  },
  {
    ...
    profileImageUri:
      "https://drive.google.com/uc?export=download&id=1WoeWEPUu68OhUhuGb7IHa10ov856wW78",
  ...
  },
  {
    ...
    profileImageUri:
      "https://drive.google.com/uc?export=download&id=1I0py7pF-1sl2LlSrsXrseMN91zTcjmFP",
    ...
    aboutSections: [
      {
        title: "Mission",
        paragraphs: ["Make beautiful jewelry accessible and affordable."],
      },
    ],
    stats: [
